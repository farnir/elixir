...
, function(t, e, n) {
    ...
    window.tram = function(t) {
        ...
        var F = e.frame = function() {
          ...
          , L = l(function(e) {
            ...
            function h() {
                ...
                this.el.style[T.transition.dom] = n)
            }
            function d(t, e, i) {
                var o, a, s, u, c = e !== p, l = {};
                for (o in t)
          ...
          , U = l(function(t) {
            ...
            t.init = function(t, e, n, i) {
                ...
                this.string = this.name + z + this.duration + "ms" + ("ease" != this.ease ? z + f[this.ease][0] : "") + (this.delay ? z + this.delay + "ms" : ""))
            }
            ,
            t.set = function(t) {
        ...
        T.transform && T.backface && (J.z = [x, "translateZ"],
        J.rotateZ = [_],
        J.scaleZ = [g],
        J.perspective = [y]);
        var Q = /ms/
...
, function(t, e, n) {
    ...
    i.define("forms", t.exports = function(t, e) {
        var n, r, o, a, s, u = {}, c = t(document), l = window.location, f = window.XDomainRequest && !window.atob, h = ".w-form", d = /e(-)?mail/i, p = /^\S+@\S+$/, v = window.alert, m = i.env(), w = /list-manage[1-9]?.com/i, g = e.debounce(function() {
        ...
        function b(e, n) {
            ...
            o.fileUploads.each(function(e) {
                !function(e, n) {
                    if (!n.fileUploads || !n.fileUploads[e])
                        return;
                    var i, r = t(n.fileUploads[e]), o = r.find("> .w-file-upload-default"), a = r.find("> .w-file-upload-uploading"), u = r.find("> .w-file-upload-success"), c = r.find("> .w-file-upload-error"), l = o.find(".w-file-upload-input"), f = o.find(".w-file-upload-label"), h = f.children(), d = c.find(".w-file-upload-error-msg"), p = u.find(".w-file-upload-file"), v = u.find(".w-file-remove-link"), w = p.find(".w-file-upload-file-name"), g = d.attr("data-w-size-error"), b = d.attr("data-w-type-error"), _ = d.attr("data-w-generic-error");
                    if (m)
            ...
            w.test(u) ? o.handler = S : u || (r ? o.handler = k : g())
        }
        function y(t) {
        ...
        return u.ready = u.design = u.preview = function() {
            !function() {
                ...
                f && a.indexOf("https://webflow.com") >= 0 && (a = a.replace("https://webflow.com", "http://formdata.webflow.com"));
                if (s = "".concat(a, "/signFile"),
                !(n = t(h + " form")).length)
                    return;
                n.each(b)
            }(),
            m || o || (o = !0,
            c.on("submit", h + " form", function(e) {
                var n = t.data(this, h);
                n.handler && (n.evt = e,
                n.handler(n))
            }))
